...
- **有限世界视图**: 优化地图边界与跨经线航线绘制，避免无限水平滚动。
...
- **完整行程记录**:
  - 按年份分组浏览全部历史航班
  - 点击行程即可定位航线并查看详情
  - 支持按城市、机场、三字码、年份和航空公司组合筛选
- **飞行轨迹总览**:
  - 独立全景展示全部航班，不受当前查询条件影响
  - 展示飞行次数、里程、到访城市、记录区间及航线统计
  - 一键下载 2 倍分辨率 PNG，适合长期留存和分享

### ⏱️ 时光回溯（Timeline）
- **飞行轨迹回放**: 内置时间轴控制器，支持播放/暂停。
- **逐段浏览**: 支持上一段、下一段和基于真实航班序列的滑块导航。
...
4.  在浏览器中打开 `http://localhost:3080` 查看项目。
